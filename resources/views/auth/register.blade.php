                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" method="POST" action="{{route('register')}}"> <!-- action="route('login')" -->
                                ...
                                <div class="form-group mb-0">
                                    <div class="row">
                                        <div class="col-sm-6 mb-3 @error('first_name') has-danger @enderror">
                                        ...
                                        <div class="col-sm-6 mb-3 @error('last_name') has-danger @enderror">
                                            <label>Last Name</label>
                                            <input  name="last_name" type="name" class="form-control form-control-lg" value="{{ old('last_name') }}"  autocomplete="name"/>
                                            @error('last_name')
                                                <div>
                                                    <label class="error">                                          
                                                        <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group mb-0">
                                    <div class="row">
                                        <div class="col-sm-7 mb-3 @error('phone_number') has-danger @enderror" >
                                        ...
                                        <div class="col-sm-5 mb-3 @error('gender') has-danger @enderror"" >
                                            <label>Gender</label>
                                            <div class="form-radio mb-2  row ml-1" >
                                                <div class="radio-custom col-sm-6">
                                                    <input type="radio" id="male" value="1" name="gender" @if (old('gender')==1) checked @endif  class="p-p">
                                                    <label for="Male">Male</label>
                                                </div>
        
                                                <div class="radio-custom col-sm-6">
                                                    <input type="radio" id="female" value="0" name="gender" @if (old('gender')===0) checked @endif class="p-p">
